...
function lock(elementaryLock,callback){
    ...
    _requestEnqueueServer(req,(err,res)=>{
...
function _getLockUUID(){
    if(isNode)
        return process.pid+'_'+lockUUID++;
    else return _generateUUID();
}
...
export {lock, unlock, promote, getLocksBy,setEnqueueServerConnection}